...
\titulo{Monte Carlo simulation proposal for narrow-line magneto-optical traps}
...
\titleabstract{Monte Carlo simulation proposal for narrow-line magneto-optical traps}
\tituloresumo{Proposta de simula\c{c}\~ao de Monte Carlo para armadilhas magneto-\'opticas de linha estreita}
\autor{Bruno Nicolau Santos}
\autorficha{Santos, Bruno Nicolau}
\autorabr{SANTOS, B. N.}
...
\orientador{Prof. Dr. Emanuel Alves de Lima Henn}
\orientadorcorpoficha{Advisor: Emanuel Alves de Lima Henn}
\orientadorficha{Henn, Emanuel Alves de Lima, Advisor}
