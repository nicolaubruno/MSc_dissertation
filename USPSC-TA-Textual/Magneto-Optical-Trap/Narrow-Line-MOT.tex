...
\begin{enumerate}
    ...
    \item[III] \textbf{Quantum regime} ($ \eta' \sim 1 $ and $ \delta' > 1 $): in this regime, the photonic recoil is the natural energy scale and, therefore, the quantum physics governs the nMOT dynamics.
\end{enumerate}
