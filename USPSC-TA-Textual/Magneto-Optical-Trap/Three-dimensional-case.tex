...
\begin{figure}[!ht]
    \centering
    \caption{Atomic cloud shape in a very large MOT}
    \includegraphics[width=0.6\textwidth]{USPSC-img/atomic-cloud-shape.png}
    \legend{Fluorescence images of rubidium atoms in a very large MOT. \\ Source: \cite[Figure~4]{PhysRevA.90.063404}}
